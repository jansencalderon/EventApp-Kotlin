package tip.dgts.eventapp.utils;
...
public class DateTimeUtils {
    ...
    public static String toReadableString(String dateToConvert) {
        SimpleDateFormat to = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US); // wanted format
        SimpleDateFormat from = new SimpleDateFormat("E, MMM dd h:mm a", Locale.US); // current format
        try {
            Date date = to.parse(dateToConvert);
    ...
    public static String toReadableStringNoTime(String dateToConvert) {
        SimpleDateFormat to = new SimpleDateFormat("yyyy-MM-dd", Locale.US); // wanted format
        SimpleDateFormat from = new SimpleDateFormat("E, MMM dd", Locale.US); // current format
        try {
            Date date = to.parse(dateToConvert);
            return from.format(date);
        } catch (ParseException e) {
    ...
    public static String toAMPM(String dateToConvert) {
        SimpleDateFormat from = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US); // wanted format
        SimpleDateFormat to = new SimpleDateFormat("h:mm a", Locale.US); // current format
        try {
            Date date = from.parse(dateToConvert);
    ...
    public static String timeToAMPM(String dateToConvert) {
        String sDate = "0000-00-00 "+dateToConvert;
        SimpleDateFormat from = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US); // wanted format
        SimpleDateFormat to = new SimpleDateFormat("h:mm a", Locale.US); // current format
        try {
            Date date = from.parse(sDate);
            return to.format(date);
        } catch (ParseException e) {
            e.printStackTrace();
            return "";
