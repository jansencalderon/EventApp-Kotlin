...
import tip.dgts.eventapp.databinding.ItemSponsorSmallBinding
...
class SponsorSmallListAdapter(private val view: EventSimpleDetailView) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val binding = DataBindingUtil.inflate<ItemSponsorSmallBinding>(
                LayoutInflater.from(parent.context), R.layout.item_sponsor_small, parent, false)
    ...
    inner class ViewHolder(val binding: ItemSponsorSmallBinding) : RecyclerView.ViewHolder(binding.root)
